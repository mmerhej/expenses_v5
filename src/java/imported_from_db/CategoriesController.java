...
public class CategoriesController implements Serializable {
    ...
    @EJB
    private imported_from_db.CategoriesFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/expBundle").getString("CategoriesCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/expBundle").getString("CategoriesUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/expBundle").getString("CategoriesDeleted"));
        if (!JsfUtil.isValidationFailed()) {
